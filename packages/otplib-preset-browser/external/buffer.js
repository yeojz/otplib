          ...
          (function(r) {
            ...
            (e.kMaxLength = o),
              ...
              (r.compare = function(t, e) {
                if (
                  (z(t, Uint8Array) && (t = r.from(t, t.offset, t.byteLength)),
              ...
              (r.concat = function(t, e) {
                ...
                for (n = 0; n < t.length; ++n) {
                  var f = t[n];
                  if ((z(f, Uint8Array) && (f = r.from(f)), !r.isBuffer(f)))
                    throw new TypeError(
                      '"list" argument must be an Array of Buffers'
                    );
        ...
        function(t, r, e) {
          (e.read = function(t, r, e, n, i) {
            var o,
              ...
              l = t[r + p];
            for (
              p += c, o = l & ((1 << -a) - 1), l >>= -a, a += u;
              a > 0;
              o = 256 * o + t[r + p], p += c, a -= 8
            );
            for (
              f = o & ((1 << -a) - 1), o >>= -a, a += n;
              a > 0;
              f = 256 * f + t[r + p], p += c, a -= 8
            );
            if (0 === o) o = 1 - h;
            else {
                ...
                r = Math.abs(r),
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((f = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      (r += f + p >= 1 ? c / s : c * Math.pow(2, 1 - p)) * s >=
                        2 && (f++, (s /= 2)),
                      f + p >= a
                        ? ((u = 0), (f = a))
                        : f + p >= 1
                        ? ((u = (r * s - 1) * Math.pow(2, i)), (f += p))
                        : ((u = r * Math.pow(2, p - 1) * Math.pow(2, i)),
                          (f = 0)));
                i >= 8;
